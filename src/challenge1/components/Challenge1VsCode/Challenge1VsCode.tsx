...
`;
  ...
  return (
    <>
      ...
      <p>
        Si has llegado a los settings de usuario en formato JSON, te saldrá un
        archivo vacío o quizás ya tenga información. Dentro de este archivo, la
        información se organiza con esta forma:
      </p>
